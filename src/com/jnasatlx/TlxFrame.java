...
public class TlxFrame extends JFrame{
	...
	JPanel uberCardPanel = new JPanel();
	HashMap<String, JPanel> cardMap = new HashMap<String, JPanel>();
	Card1Panel card1Panel = new Card1Panel();
	Card2Panel card2Panel = new Card2Panel();
	Card3Panel card3Panel = new Card3Panel();
	...
	class Card3Panel extends JPanel{
		...
		class ComparisonCardPanel extends JPanel{
			...
			public ComparisonCardPanel(final int index){
