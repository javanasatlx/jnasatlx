...
public class TlxScalePanel extends JPanel{
	...
	TlxScalePanel(String scaleTitleText, String scaleLowText, String scaleHighText, String scaleDescriptionText){
		super();
	...
	class ScaleButton extends JButton{
		...
		ScaleButton(int index){
			this.index = index;
			this.setBackground(notSelectedColor);
			this.addActionListener(e -> buttonActionPerformed());
		}
		...
		private void buttonActionPerformed(){
			...
			this.setOpaque(true);//for Macs
			this.setBorderPainted(false);//for Macs
	...
	static Dimension getScaleDescTextAreaDimension(){
		return scaleDescTextAreaDimension;
	}
}
